...
def parse_args():
    ...
    parser.add_argument("--limit-per-class", type=int, default=None, help="Optional small subset for quick tests.")
    return parser.parse_args()

def main():
    args = parse_args()
    train_model(data_dir=args.data_dir, task=args.task, epochs=args.epochs, batch_size=args.batch_size, output_dir=args.output_dir, limit_per_class=args.limit_per_class)
